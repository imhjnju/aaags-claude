...
- Full CTest after feature-matrix, render-SH, and DSSIM optimization fixes: **315/315 tests passed** (`ctest --test-dir harmonyos_3dgs/build --output-on-failure`, latest 40.03s; expected inventory is 66 .cpp files).
...
### S15 — 2026-04-30 (current) — Full-dataset feature matrix
