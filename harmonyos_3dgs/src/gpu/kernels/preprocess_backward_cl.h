// Auto-generated from preprocess_backward.cl -- do not edit
static const char preprocess_backward_cl_src[] = R"CL(
...
__kernel void preprocess_backward(
    ...
    __global const float* restrict sh_coeffs,
    __global const float* restrict scales,
    __global const float* restrict rotations,
    __global const float* restrict opacities,
    __constant const float* restrict view_matrix,
    __constant const float* restrict viewproj,
    __constant const float* restrict cam_pos_buf,
    const int N,
    const int width,
    const int height,
    ...
    __global const float* restrict cov2D,
    __global const float* restrict cov2D_det,
    __global const float* restrict p_view,
    __global const float* restrict p_hom_w,
    __global const float* restrict means2D_fwd,
    __global const int*   restrict radii,
    __global const float* restrict d_means2D,
    __global const float* restrict d_conics,
    __global const float* restrict d_rgb,
    __global const float* restrict d_opacities_2d,
    __global const float* restrict raw_rotations,
    __global float* restrict d_raw_positions,
    __global float* restrict d_raw_scales,
    __global float* restrict d_raw_rotations,
    __global float* restrict d_raw_sh_coeffs,
    __global float* restrict d_raw_opacities
)
{
    ...
    // Chain 1: d_conics -> d_cov2D -> d_cov3D -> d_scales, d_rotations
    {
        ...
        float t[3];
        t[0] = p_view[i*3]; t[1] = p_view[i*3+1]; t[2] = p_view[i*3+2];
