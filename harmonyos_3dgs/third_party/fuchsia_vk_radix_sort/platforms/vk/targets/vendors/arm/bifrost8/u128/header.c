...
#include "target.h"
static
#include "bifrost8_u128_init.comp.h"
static
#include "bifrost8_u128_fill.comp.h"
static
#include "bifrost8_u128_histogram.comp.h"
static
#include "bifrost8_u128_prefix.comp.h"
static
#include "bifrost8_u128_scatter_0_even.comp.h"
static
#include "bifrost8_u128_scatter_0_odd.comp.h"
static
#include "bifrost8_u128_scatter_1_even.comp.h"
static
#include "bifrost8_u128_scatter_1_odd.comp.h"
static
#include "bifrost8_u128_scatter_2_even.comp.h"
static
#include "bifrost8_u128_scatter_2_odd.comp.h"
static
#include "bifrost8_u128_scatter_3_even.comp.h"
static
#include "bifrost8_u128_scatter_3_odd.comp.h"

const struct radix_sort_vk_target bifrost8_u128_target =
{
  ...
  .modules = {
    ...
    .module_size = {
      ...
      sizeof(scatter_2_even_comp_shader_binary),
      sizeof(scatter_2_odd_comp_shader_binary),
      sizeof(scatter_3_even_comp_shader_binary),
      sizeof(scatter_3_odd_comp_shader_binary)
    },
    .module_data = {
      ...
      scatter_2_even_comp_shader_binary,
      scatter_2_odd_comp_shader_binary,
      scatter_3_even_comp_shader_binary,
      scatter_3_odd_comp_shader_binary
    }
  }
};
